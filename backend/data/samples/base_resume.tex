...
\begin{center}
    \textbf{\Huge \scshape Karthik Vakada} \\ \vspace{1pt}
    8417 48th Ave, College Park, MD, 20740 \\ \vspace{1pt}
    \small 937-965-9901 $|$ \href{mailto:kvakada@umd.edu}{\underline{kvakada@umd.edu}} $|$ 
    \href{https://www.linkedin.com/in/karthik-vakada/}{\underline{https://www.linkedin.com/in/karthik-vakada/}} $|$
    \href{https://github.com/kvakada}{\underline{https://github.com/kvakada}}
\end{center}
...
\resumeSubHeadingListStart
   \resumeSubheading
      {University of Maryland, College Park, United States \scriptsize{} }{CGPA: 4/4}
      {Master of Science in Data Science}{August 2024 - Dec 2025}
      \resumeItemListStart
      \item \textbf{Relevant Coursework:}
      \resumeItemListEnd

      \resumeSubheading
      {Gandhi Institute of Technology and Management, India \scriptsize{} }{CGPA: 8.01/10}
      {Bachelor of Technology in Computer Science and Engineering}{June 2019- May 2023}
      \resumeItemListStart
      \item \textbf{Relevant Coursework:}
\resumeItemListEnd
...
\resumeSubheading
  {Business Analyst}{September 2025 -- December 2025}
  {Element Fleet Management}{Baltimore, MD}
  \resumeItemListStart
...
\resumeSubheading
  {Business Analyst Intern}{June 2025 -- August 2025}
  {Element Fleet Management}{Baltimore, MD}
    ...
    \resumeItemListEnd
\resumeSubheading
  {Data Science Intern}{April 2024 -- July 2024}
...
\resumeSubheading
  {AI/ML Engineer}{June 2023 -- February 2024}
  {Cloud Technologies} {Hyderabad, India}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \item {Improved analytical efficiency by 30\% at Element Fleet Management by automating dashboards and standardizing reporting workflows, earning formal recognition from senior leadership.}
    \item {Led a company-wide School Supplies Drive, coordinating 50 employees across multiple offices and increasing donation volume by 40\% year-over-year; recognized by executive leadership for organizational impact.}
    \item {Contributed to the UMD Data Science community by mentoring 20+ peers on SQL query optimization and Power BI performance tuning, resulting in an average 25\% improvement in report refresh times.}
